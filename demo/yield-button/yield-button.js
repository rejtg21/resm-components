...
var _resmComponents = __webpack_require__(26);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_resmComponents.YieldButton, { className: 'btn btn-success', btnName: 'Save', loadingText: 'Teka Lang', onClick: function onClick() {
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(2),m=__webpack_require__(8),p=__webpack_require__(3),v=__webpack_require__(1),da=__webpack_require__(9),ea=__webpack_require__(10),fa=__webpack_require__(11),ha=__webpack_require__(5);
...
var _YieldButton = __webpack_require__(27);

var _YieldButton2 = _interopRequireDefault(_YieldButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = {
    YieldButton: _YieldButton2.default
};
...
var YieldButton = function (_React$Component) {
    _inherits(YieldButton, _React$Component);

    function YieldButton(props) {
        _classCallCheck(this, YieldButton);

        var _this = _possibleConstructorReturn(this, (YieldButton.__proto__ || Object.getPrototypeOf(YieldButton)).call(this, props));

        _this.state = {
            disabled: false,
            currentText: _this.props.btnName
        };

        // function bindings
        _this.handleClick = _this.handleClick.bind(_this);
        _this._disable = _this._disable.bind(_this);
        _this._enable = _this._enable.bind(_this);
        return _this;
    }

    _createClass(YieldButton, [{
        key: 'handleClick',
        value: function handleClick(e) {
            var _this2 = this;

            this._disable();
            var defer = this.props.onClick(e);
        ...
        value: function _disable() {
            ...
            var alternateText = this.props.loadingText || this._progressiveForm(this.props.btnName);
            this.setState({
                disabled: true,
        ...
        key: '_progressiveForm',
        value: function _progressiveForm(text) {
            var vowels = ['e', 'E'];
            var progressiveText = 'ing ...';
            // split the value to array
            var unFormatText = text.trim().split("");
